export const Hero= ({ image, stylecss, linecss, headcss, headcontent, underline, paracss, paracontent, lineimagecss }) => {
  return (
    <>
    <div className={`w-full  bg-cover bg-center  relative text-white  h-[200px] sm:h-[200px] md:h-[418.64px] lg:h-[618.64px] xl:h-[738.64px] z-30 ${stylecss}`} style={{ backgroundImage: `url(${image})` }}>
