...
export default function Coffee_page() {
  ...
  return (
     <div className='relative'>
      ...
      <img class="absolute top-[1060px]  right-1 z-40 " src={tbean} alt={tbean} />
      <img class="absolute top-[1395px]  left-[400px]  z-0 " src={tbean} alt={tbean} />
      <img class="absolute top-[1610px]  right-0 z-40 " src={beanr} alt={beanr} />      
