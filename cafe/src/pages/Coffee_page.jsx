...
export default function Coffee_page() {
  ...
  return (
     <div className='relative '>
      ...
      <img className="absolute z-0     h-auto w-12 sm:w-12 md:w-20 lg:w-32 xl:w-44            xl:top-[1390px] xl:left-[350px]      lg:top-[1230px] lg:left-[230px]   md:top-[990px] md:left-[170px] top-[620px]  left-[100px]  " src={tbean} alt={tbean} />
      <img className="absolute z-40          h-auto w-20 sm:w-24 md:w-32 lg:w-40 xl:w-44      xl:top-[1620px] right-0      lg:top-[1370px]                        md:top-[1100px]  top-[710px] " src={beanr} alt={beanr} />      
      ...
      <img className="absolute z-40 -rotate-[30deg]      h-auto w-12 sm:w-12 md:w-20 lg:w-32 xl:w-44          xl:bottom-[1190px]  xl:right-[390px]   lg:bottom-[960px]  lg:right-[250px]   md:bottom-[858px] md:right-[190px]  bottom-[590px] right-0" src={tbean} alt={tbean} />
